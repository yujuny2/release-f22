...
TEST_CASE("List::reverseNth #0", "[weight=5][part=2]") {
  List<int> list;
  ...
  REQUIRE( "< 3 2 1 6 5 4 8 7 >" == s1.str() );
}
...
TEST_CASE("List::merge #0", "[weight=10][part=2][valgrind]") {
  List<int> list1;
  List<int> list2;
  ...
  REQUIRE( "< 1 2 3 3 5 5 9 10 >" == s1.str() );
}
